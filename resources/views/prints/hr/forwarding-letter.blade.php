...
@media print {
  ...
  /* @page provides the 12mm safe margin; the wrapper adds none so content
     never lands in the printer's unprintable bottom zone (no more cut). */
  .a4-page {
    width: 100%;
    margin: 0;
    padding: 0;
...
<div class="no-print" style="background:#1a1f2e;color:#fff;padding:7pt 12pt;margin-bottom:6pt;font-size:8pt;">
  <strong>Forwarding Letter</strong> — {{ $full_name_en }}
  &nbsp;&nbsp;
  ...
  &nbsp;
  <a href="{{ route('hr.download.forwarding-letter', request()->route('hr')) }}" style="background:#16a34a;color:#fff;padding:3pt 10pt;border-radius:3pt;text-decoration:none;">&#8595; PDF</a>
</div>
@endif
