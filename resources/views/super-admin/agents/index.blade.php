...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h5 class="mb-0 fw-bold"><i class="bi bi-people me-1"></i> All Agents</h5>
    <small class="text-muted">Read-only view across all agencies</small>
</div>
            ...
            <div class="col-md-3">
                <select name="agency_id" class="form-select form-select-sm">
                    ...
                    @foreach($agencies as $ag)
                        <option value="{{ $ag->id }}" @selected(request('agency_id') == $ag->id)>
                            {{ $ag->name }}
                        </option>
                    @endforeach
                </select>
        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('super-admin.agencies.show', $agent->agency_id) }}"
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            <a href="{{ route('super-admin.agents.show', $agent) }}"
                ...
                <tr>
                    <td colspan="8" class="text-center text-muted py-4">
                        <i class="bi bi-people fs-2 opacity-25 d-block mb-1"></i>
                        No agents found.
                    </td>
                </tr>
                @endforelse
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <p>Delete agent <strong id="deleteAgentName"></strong>?</p>
...
document.getElementById('deleteModal').addEventListener('show.bs.modal', function(e) {
    ...
    document.getElementById('deleteForm').action = '/super-admin/agents/' + btn.dataset.agentId;
});
</script>
@endpush
