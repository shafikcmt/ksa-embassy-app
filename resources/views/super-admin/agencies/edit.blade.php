    ...
    <div class="col-lg-8">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">RL No / Recruiting License</label>
                        <input type="text" name="rl_number" class="form-control @error('rl_number') is-invalid @enderror"
                            value="{{ old('rl_number', $agency->rl_number) }}" placeholder="Optional">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">System License Number</label>
                        <input type="text" class="form-control" style="background:#eef1f5;" disabled readonly
                            value="{{ $agency->license_number ?? '—' }}">
                        <div class="form-text">Auto-generated by the system.</div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">Current Subscription</label>
                        <input type="text" class="form-control" style="background:#eef1f5;" disabled readonly
                            value="{{ $sub ? ($sub->plan->name ?? '—') . ' · ' . ucfirst($sub->status) : 'No active subscription' }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Assign / Change Plan</label>
                        <select name="plan_id" class="form-select @error('plan_id') is-invalid @enderror">
                            <option value="">— Keep current subscription —</option>
                        ...
                        <div class="form-text">Selecting a plan starts a new trial subscription.</div>
