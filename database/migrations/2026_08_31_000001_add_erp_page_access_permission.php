...
/**
 * Introduce the access_erp page-access permission for the ERP Suite module
 * (see App\Support\PagePermissions).
 *
 * Behaviour is grandfathered exactly like the earlier page-access migrations
 * (2026_08_30_000003 / 2026_08_30_000008): every EXISTING agency_staff account
 * is backfilled so nothing they can do today changes. Only staff created AFTER
 * this migration start without it unless the admin enables it on the Staff
 * Accounts screen.
 *
...
{
    private const PERMISSION = 'access_erp';
